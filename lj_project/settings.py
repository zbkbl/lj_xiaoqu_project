...
# Scrapy settings for lj_project project
#
...
SPIDER_MODULES = ['lj_project.spiders']
NEWSPIDER_MODULE = 'lj_project.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'lj_project (+http://www.yourdomain.com)'
...
#SPIDER_MIDDLEWARES = {
#    'lj_project.middlewares.LjProjectSpiderMiddleware': 543,
#}
